...
UReferenceManager::UReferenceManager()
{
	static ConstructorHelpers::FClassFinder<ACharacter> playableCharacter = TEXT("/Game/Slow/Blueprints/Actor/BP_SlowPlayableCharacter");

	TypeofPlayerCharacter = playableCharacter.Class;
}
